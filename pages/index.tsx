...
const Home: NextPage = () => {
  ...
  const onWithdrawWinnings = async () => {
    ...
    try {
      ...
      console.error("contract call faliure", err);
    }
  };
  ...
  return (
    <div className="bg-[#091b18] min-h-screen flex flex-col">
          ...
          <div className="stats-container space-y-2">
            <div className="stats-container">
              ...
              <button
                ...
                className="font-semibold mt-5 w-full bg-gradient-to-br from-orange-500 to-emerald-600 px-10 py-5 rounded-md text-white shadow-xl disabled:from-gray-600 disabled:text-gray-100 disabled:to-gray-600 disabled:cursor-not-allowed"
                onClick={handleClick}
              >
      ...
      <footer className="p-4 border-t border-emerald-500/20 flex items-center text-white justify-center">
        <h1 className="text-xs text-emerald-900">
          Made with ♥ by{" "}
          <Link href="https://github.com/SanyamPunia">Sanyam</Link>
        </h1>
      </footer>
    </div>
  );
